...
const MANUAL_ROUTE_MAP: Record<string, string> = {
  ...
  "docs/user-manual/en/growth-plan.md": "/help/growth-plan",
  ...
  "docs/user-manual/en/ai-coaching.md": "/help/ai-coaching",
  "docs/user-manual/en/notebook.md": "/help/notebook",
  "docs/user-manual/en/back-study.md": "/help/back-study",
  "docs/user-manual/en/rules-alarms.md": "/help/rules-alarms",
  "docs/user-manual/en/challenges.md": "/help/challenges",
  "docs/user-manual/en/data-inputs.md": "/help/data-inputs",
  "docs/user-manual/en/option-flow.md": "/help/option-flow",
  "docs/user-manual/en/reports.md": "/help/reports",
  "docs/user-manual/en/post-mortem.md": "/help/post-mortem",
  "docs/user-manual/en/forum.md": "/help/forum",
  "docs/user-manual/en/global-ranking.md": "/help/global-ranking",
  "docs/user-manual/en/resources.md": "/help/resources",
  "docs/user-manual/en/billing.md": "/help/billing",
  ...
  "docs/user-manual/es/growth-plan.md": "/help/growth-plan",
  ...
  "docs/user-manual/es/ai-coaching.md": "/help/ai-coaching",
  "docs/user-manual/es/notebook.md": "/help/notebook",
  "docs/user-manual/es/back-study.md": "/help/back-study",
  "docs/user-manual/es/rules-alarms.md": "/help/rules-alarms",
  "docs/user-manual/es/challenges.md": "/help/challenges",
  "docs/user-manual/es/data-inputs.md": "/help/data-inputs",
  "docs/user-manual/es/option-flow.md": "/help/option-flow",
  "docs/user-manual/es/reports.md": "/help/reports",
  "docs/user-manual/es/post-mortem.md": "/help/post-mortem",
  "docs/user-manual/es/forum.md": "/help/forum",
  "docs/user-manual/es/global-ranking.md": "/help/global-ranking",
  "docs/user-manual/es/resources.md": "/help/resources",
  "docs/user-manual/es/billing.md": "/help/billing",
