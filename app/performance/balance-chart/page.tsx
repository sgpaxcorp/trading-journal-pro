...
import { getGrowthPlan, GrowthPlan } from "@/lib/growthPlanLocal";
...
export default function BalanceChartPage() {
  ...
  const {
    ...
    const planDateStr = plan.createdAt.slice(0, 10);
    ...
    filtered.forEach((e) => {
      pnlByDate.set(e.date, (pnlByDate.get(e.date) ?? 0) + (e.pnl || 0));
    });
    ...
    for (let i = 0; i < effectiveTradingDays; i++) {
      ...
      if (dailyTargetPct > 0) {
        ...
        const dayInWeek = i % 5;
        const isLossDay =
          lossDaysPerWeek > 0 && dayInWeek < lossDaysPerWeek && maxDailyLossPct > 0;
      ...
      <div className="px-6 md:px-10 py-8 max-w-5xl mx-auto">
        ...
        {!plan && (
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 text-sm text-slate-300">
            You don&apos;t have a growth plan yet. Create one first so we can project your
            balance over time.
          </div>
        )}
        ...
        {plan && !hasData && (
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 text-sm text-slate-300">
            We haven&apos;t found any trading days in this plan yet. Log your
            trades to see your balance evolution.
          </div>
        )}
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Trading days only (Mon–Fri), from your first trading day in this plan
                    to your latest trading day.
                  </p>
                </div>
            ...
            <section className="mt-6 rounded-2xl border border-slate-800 bg-slate-900/60 p-4 md:p-5 text-sm text-slate-200">
              ...
              {diff >= 0 ? (
                <p className="text-emerald-300">
                  ...
                  protecting your downside, and reviewing your statistics to refine your
                  technique.
                </p>
              ) : (
                <p className="text-slate-300">
                  You are currently below the projected curve, but you are still in the
                  game. You are doing well—stay on track with your rules and review your
                  statistics so you can find specific areas to improve your technique.
                </p>
              )}
            </section>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-3">
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">
                    Trading days only, from your first trading day in this plan to your
                    current trading day.
                  </p>
                </div>
