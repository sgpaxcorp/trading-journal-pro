...
const CONTENT = {
  en: {
    ...
    sections: [
      ...
      {
        title: "9.1 Launch Waitlist Promotions",
        body:
          "From time to time, NTJ may offer promotional waitlist discounts. The launch waitlist promotion currently advertised provides a thirty percent (30%) discount on the annual plan for the first five hundred (500) eligible waitlist registrations, subject to verification, availability, and successful checkout during the promotion period. Promotional discounts are not cash, are not transferable, may be limited to one per person/email/payment method, may not be combined with other offers unless expressly stated, and may expire if not used by the deadline communicated by NTJ. Joining the waitlist does not guarantee access, pricing, a subscription, trading results, income, capital growth, or any financial outcome.",
      },
      {
  ...
  es: {
    ...
    sections: [
      ...
      {
        title: "9.1 Promociones de lista de espera de lanzamiento",
        body:
          "Periódicamente, NTJ puede ofrecer descuentos promocionales de lista de espera. La promoción de lanzamiento actualmente anunciada ofrece un treinta por ciento (30%) de descuento en el plan anual para los primeros quinientos (500) registros elegibles en la lista de espera, sujeto a verificación, disponibilidad y checkout exitoso durante el periodo promocional. Los descuentos promocionales no son efectivo, no son transferibles, pueden limitarse a uno por persona/email/método de pago, no pueden combinarse con otras ofertas salvo indicación expresa, y pueden expirar si no se usan antes de la fecha límite comunicada por NTJ. Unirse a la lista de espera no garantiza acceso, precio, suscripción, resultados de trading, ingresos, crecimiento de capital ni ningún resultado financiero.",
      },
      {
