-- Production backfill for environments where the original
-- 20260414_stripe_email_deliveries migration was marked applied in
-- schema_migrations but the table itself is missing.
--
