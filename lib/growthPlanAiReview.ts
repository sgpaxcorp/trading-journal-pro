...
export function buildGrowthPlanReviewInstructions(): string {
  return [
    ...
    "- Use the supplied business profile (risk posture, experience, income dependency, drawdown comfort, and trading style) to explain fit, behavioral pressure, and confidence in the recommendation.",
    ...
    "- Business-profile answers may change fit and coaching, but never alter or override the deterministic snapshot numbers.",
