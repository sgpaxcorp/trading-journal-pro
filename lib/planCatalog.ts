...
> = {
  core: {
    ...
    pricingFeatures: [
      ...
      { en: "Trade review & business milestones", es: "Revisión de trades y milestones empresariales" },
    ...
    billingHighlights: [
      ...
      { en: "Trade review and business milestones", es: "Revisión de trades y milestones empresariales" },
  ...
  advanced: {
    ...
    pricingFeatures: [
      ...
      { en: "Strategy review / back-study workspace", es: "Workspace de revisión estratégica / back-study" },
...
export const PLAN_COMPARISON_ROWS: PlanComparisonRow[] = [
  ...
  { kind: "feature", label: { en: "Strategy review / back-study workspace", es: "Workspace de revisión estratégica / back-study" }, core: false, advanced: true },
