...
export function getOptionFlowBetaCopy(lang: OptionFlowLang) {
  if (lang === "es") {
    return {
      badge: "BETA PRIVADA",
      title: "Option Flows Analysis está en beta privada",
      description:
        "Option Flows Analysis convierte screenshots o archivos de flujo de opciones en un reporte premarket estructurado con resumen asistido por IA, niveles clave, contexto ASK/BID y notas de riesgo.",
      availability:
  ...
  return {
    badge: "PRIVATE BETA",
    title: "Option Flows Analysis is in private beta",
    description:
      "Option Flows Analysis turns options flow screenshots or files into a structured premarket report with AI-assisted summaries, key levels, ASK/BID context, and risk notes.",
    availability:
