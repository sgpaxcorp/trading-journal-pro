...
## Access
- Left navigation → Settings / Account Preferences.
...
## Language
Open the Language section and choose Auto, English, or Español. The interface updates immediately.
...
## FAQ
Q: I changed language but some areas did not update.  
A: Some sections update progressively. Refresh the page.
