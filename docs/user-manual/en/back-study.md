...
5. Execution audit summary for the selected trade.
6. Trade sequence from broker events.
7. Process review and deterministic insights.
8. Raw execution evidence.
