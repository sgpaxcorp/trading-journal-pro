...
Why it matters: drives trading‑day count and pacing.  
How to fill it: pick a date you can honor without forcing unrealistic daily returns.

## 4) Trading Days
What it is: the number of trading days you commit to between today and your target date.  
How it’s set: auto‑calculated using NYSE trading days (holidays excluded).  
When to edit: if you know you will trade fewer or more days than the default.
...
## 8) Required Goal‑Day %
What it is: the daily % you must achieve on **goal days** to reach your target (after loss days are accounted for).  
Why it matters: it translates your plan into a realistic daily target.  
How to use it: treat it as your “green‑day” benchmark, not a daily guarantee.
