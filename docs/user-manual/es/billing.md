...
La ventana de cancelación empieza con una encuesta. Se le pide al usuario:
...
5. Una casilla de confirmación que el usuario debe aceptar.
...
5. Las respuestas de la encuesta se guardan para ayudar a NeuroTrader Journal a mejorar el servicio.
6. Más adelante puedes recibir una invitación para regresar a la plataforma.
...
## Emails de billing
NeuroTrader Journal envía los principales emails del ciclo de suscripción con el mismo estilo visual de la plataforma.
...
6. `Invitación para regresar` más adelante si la suscripción continúa cancelada.
